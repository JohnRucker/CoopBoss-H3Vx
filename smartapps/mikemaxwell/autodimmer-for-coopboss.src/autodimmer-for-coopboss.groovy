 ...
 *  Author: Mike Maxwell 
    ...
    2.2 2016-01-05
    	--John Rucker: comment out line 70 and added 71, comment out line 276 and added line 277, changed name from autoDimmer to AutoDimmer for CoopBoss.
        
 */
definition(
    name			: "autoDimmer for CoopBoss",
...
def init(){
    ...
    subscribe(luxOmatic, "currentLightLevel", luxHandler)
}
def dimHandler(evt) {
